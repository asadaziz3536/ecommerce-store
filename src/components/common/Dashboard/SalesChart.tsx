...
export default function USSalesMap() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md p-5 flex flex-col md:flex-row gap-6 w-full max-w-3xl">
      {/* Left: Map */}
      ...
      <div className="flex flex-col justify-center gap-3 flex-1">
        {salesData.slice(0, 3).map((item) => (
          <div key={item.code} className="flex justify-between items-center border-b pb-2">
