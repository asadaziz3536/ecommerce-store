...
export const MainMenu = ({ onClose, isOpen }: Props) => {
  ...
  return (
    <nav
      ...
      } md:left-0  transition-transform duration-300 ease-in-out  top-0 bottom-0 bg-white w-[300px] h-full md:bg-transparent md:w-auto md:h-auto md:relative overflow-auto md:overflow-visible z-100  md:shadow-none md:translate-x-0`}
    >
      {/* Logo */}
