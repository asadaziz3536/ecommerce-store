...
const ContactUs = () => {
 ...
 const sendEmail=(e)=>{
  ...
  emailjs.sendForm("service_w72e7py", "template_h3hxsyc", form.current, {
    ...
    <div className="max-w-screen-xl m-auto">
      ...
      <div className="grid grid-cols-12 gap-8">
        <div className="col-span-12 md:col-span-6">
          ...
          <img className="h-[300px] md:h-[522px] w-full object-cover" src={phoneImg} alt="" />
        </div>
        <div className="col-span-12 md:col-span-6">
          <form ref={form} onSubmit={sendEmail}>

<input type="hidden" name="time" id=""  value={new Date().toLocaleString()}  />
            ...
            <Button type="submit" value="Send" className="px-8">Submit</Button>
          </form>
        </div>
      </div>
