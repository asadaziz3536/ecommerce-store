...
import { addToCart, clearCart, deleteFromCart, removeFromCart } from "@/store/cart";
          ...
          <div className="grid grid-cols-12 md:gap-6">
            <div className="col-span-12 lg:col-span-8 overflow-auto">
              ...
              <div className="flex flex-row md:grid md:grid-cols-12 gap-5 pb-4">
                ...
                <div className="font-semibold md:col-span-2 flex-[0_0_100px]">Prices</div>
              ...
              <Button onClick={()=>dispatch(clearCart())} className="mt-5">Clear Cart</Button>
            </div>
